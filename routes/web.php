...
Route::get('/questions/{slug}','QuestionsController@show')->name('questions.show'); // Show question

Route::get('/{username}','UserController@show')->name('user.profile'); //Profile link
